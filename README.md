...
components/
  PasteInput.tsx     app shell (4-pane IDE): paste/append + paste-anywhere, tables[] + shared styles, localStorage persistence, undo, combined preview, Copy-all confirmation, pinned preview (Preview/Table/JSON tabs, This-section/All-sections scope) + Copy all
