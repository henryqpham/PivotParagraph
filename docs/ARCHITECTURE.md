...
clipboard (text/html, else text/plain)
  ...
  -> tableToHtml(t, titleIsHeading):
       rowsToPivotTree(grid, pivotLevels, sortDirs)   (build first-seen, then sort-post-pass)
         -> renderPivotTree(tree, title?, markers, fieldLabels, breakAfter, numbering, headingLevels, titleIsHeading)  -> HTML fragment
...
flowchart TD
    ...
    RP["renderPivotTree(tree, title?, markers, fieldLabels, breakAfter, numbering, headingLevels, titleIsHeading) -> HTML fragment"]
